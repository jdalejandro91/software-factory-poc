...
from software_factory_poc.application.ports.drivers.vcs.dtos.vcs_dtos import BranchDTO, CommitResultDTO, MergeRequestDTO
...
from software_factory_poc.infrastructure.adapters.drivers.vcs.services.gitlab_branch_service import (
    GitLabBranchService,
)
