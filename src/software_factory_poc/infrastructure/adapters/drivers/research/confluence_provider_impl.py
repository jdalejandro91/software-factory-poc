...
from software_factory_poc.application.ports.drivers.research import DocumentContentDTO
from software_factory_poc.application.ports.drivers.research import ProjectContextDTO
