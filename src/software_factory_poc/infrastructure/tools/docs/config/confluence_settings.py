...
class ConfluenceSettings(BaseSettings):
    ...
    architecture_doc_page_id: str = Field(
        default="3571713",
        description="Page ID for architecture docs",
        alias="ARCHITECTURE_DOC_PAGE_ID",
    )

    model_config = SettingsConfigDict(
        env_prefix="CONFLUENCE_", case_sensitive=False, extra="ignore"
    )
