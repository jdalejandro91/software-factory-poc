...
from software_factory_poc.application.drivers.common.config.task_status import TaskStatus
from software_factory_poc.application.drivers.common import (
    ProviderError,
)
...
from software_factory_poc.infrastructure.drivers.tracker.dtos.jira_status_enum import JiraStatus
...
class JiraProviderImpl(TaskTrackerGateway):
    ...
    def add_comment(self, issue_key: str, body: Any) -> dict[str, Any]:
        ...
        try:
            from software_factory_poc.infrastructure.drivers.tracker.mappers.jira_panel_factory import \
                JiraPanelFactory
