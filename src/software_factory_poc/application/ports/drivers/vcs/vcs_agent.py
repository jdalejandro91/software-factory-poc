...
from software_factory_poc.application.ports.drivers.vcs.dtos.vcs_dtos import MergeRequestDTO, CommitResultDTO, BranchDTO
from software_factory_poc.application.ports.drivers.vcs.ports.vcs_gateway import VcsGateway
