    ...
    async def execute_flow(self, mission: Mission) -> None:
        ...
        try:
            ...
            if branch_exists:
                ...
                await self.tracker.add_comment(mission.key, msg)
                await self.tracker.update_status(mission.key, "In Review")
                return
            ...
            prompt = self.prompt_builder.build_prompt_from_mission(mission, arch_context)
            ...
            await self.tracker.add_comment(mission.key, metadata_comment)
            ...
            await self.tracker.add_comment(mission.key, success_msg)
