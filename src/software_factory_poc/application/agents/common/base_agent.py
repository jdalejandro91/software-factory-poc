...
from software_factory_poc.application.skills.registry import SkillRegistry
...
class BaseAgent(ABC):
    ...
    async def run(self, mission: Mission, *, skills: Optional[SkillRegistry] = None) -> Any:
        """
        Unified entrypoint.
    ...
    async def _run_react_loop(self, mission: Mission, skills: SkillRegistry) -> str:
        ...
        # BrainDriver contract already exists in your code: run_agentic_loop(prompt, tools, tool_executor)
