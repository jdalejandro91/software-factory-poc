...
from software_factory_poc.application.core.domain.agents.reporter.ports.task_tracker_gateway import TaskTrackerGateway, TaskStatus
...
class ReporterAgent(BaseAgent):
    ...
    def report_start(self, task_id: str) -> None:
        self.tracker.add_comment(task_id, "🤖 Iniciando tarea de scaffolding...")

    def report_success(self, task_id: str, message: str) -> None:
        self.tracker.add_comment(task_id, f"✅ Éxito: {message}")
